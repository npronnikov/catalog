---
name: restore-c4-architecture-java-claude-code
description: >-
...
- `CLAUDE.md` — проектные инструкции (если есть)
...
- Если существует `CLAUDE.md` — прочитать его перед началом работы для понимания контекста проекта
