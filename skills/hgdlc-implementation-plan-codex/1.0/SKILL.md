---
name: hgdlc-implementation-plan-codex
description: >
  ...
  plan that the coding agent can execute step by step without re-reading artifacts.
---
...
enough for the coding agent to execute mechanically: every file to touch, in the
